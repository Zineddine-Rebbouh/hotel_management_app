...
const Dashboard = () => {
    ...
    const { data: statsData, isLoading, error } = useQuery(
        ...
        {
            onError: () => {
                showToast({ message: "Error fetching dashboard statistics", type: "ERROR" });
            },
        }
    );
        ...
        <div className="space-y-6">
            ...
            {isLoading && (
                <div className="flex justify-center items-center p-8">
                    <div className="text-gray-500 text-lg">Loading dashboard statistics...</div>
                </div>
            )}
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-300 rounded-lg p-6">
                            <div className="text-gray-600 text-sm font-semibold mb-2">Total Hotels</div>
                            <div className="text-4xl font-bold text-blue-600">{stats.totalHotels}</div>
                        ...
                        <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-300 rounded-lg p-6">
                            ...
                            <div className="text-4xl font-bold text-green-600">{stats.totalBookings}</div>
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-300 rounded-lg p-6">
                            ...
                            <div className="text-4xl font-bold text-purple-600">£{stats.totalRevenue.toFixed(2)}</div>
                        ...
                        <div className="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-300 rounded-lg p-6">
                            <div className="text-gray-600 text-sm font-semibold mb-2">Avg Bookings/Hotel</div>
                            <div className="text-4xl font-bold text-orange-600">{stats.avgBookingsPerHotel}</div>
                            <p className="text-xs text-gray-600 mt-2">Bookings per property</p>
                        </div>
                    </div>
                        ...
                        <div className="bg-white border border-slate-300 rounded-lg p-6">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                                {Object.entries(stats.bookingsByMonth).map(([month, count]) => (
                                    ...
                                    >
                                        <p className="text-xs font-semibold text-gray-600 mb-2">{month}</p>
                                        <p className="text-2xl font-bold text-blue-600">{count}</p>
                                        <p className="text-xs text-gray-500">booking{count !== 1 ? 's' : ''}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    {stats.hotelStats.length > 0 && (
                        <div className="bg-white border border-slate-300 rounded-lg p-6">
                            <h2 className="text-2xl font-bold mb-4">Your Hotels Performance</h2>
                                    ...
                                    <tbody>
                                        {stats.hotelStats.map((hotel, idx) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3 text-gray-700">{hotel.city}</td>
                    ...
                    {stats.totalHotels === 0 && (
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center">
                            <p className="text-gray-600 text-lg">You haven't added any hotels yet.</p>
                            <a
                                href="/add-hotel"
